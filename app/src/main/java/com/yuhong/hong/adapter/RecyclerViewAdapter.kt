...
class RecyclerViewAdapter : RecyclerView.Adapter<RecyclerViewAdapter.ViewHodler> {
    ...
    override fun onCreateViewHolder(parent: ViewGroup?, viewType: Int): ViewHodler {
        var view: View = View.inflate(parent?.context, R.layout.msg_rceycler_item, null)
    ...
    class ViewHodler : RecyclerView.ViewHolder {
        ...
        constructor(view: View) : super(view) {
            msg_tv = view.findViewById(R.id.id_message_tv) as TextView
            ico_iv = view.findViewById(R.id.id_message_iv) as ImageView
