package com.yuhong.hong.calendar;
...
public class ArticleAdapter extends GroupRecyclerAdapter<String, Article> {
    ...
    private static List<Article> create(int p) {
        ...
        List<Article> sList  = new ArrayList<>();
        if (p == 0) {
            sList.add(create("新西兰克马德克群岛发生5.7级地震 震源深度10千米",
            ...
            sList.add(create("俄罗斯喊冤不当\"背锅侠\" 俄美陷入\"后真相\"旋涡",
            ...
            sList.add(create("中企投资巴西获支持 英媒:巴西人感激\"保住饭碗\"",
            ...
            sList.add(create("美电视台记者因误报有关弗林新闻被停职四周",
            ...
            sList.add(create("预计明年3月上市 曝全新奥迪Q5L无伪谍照",
